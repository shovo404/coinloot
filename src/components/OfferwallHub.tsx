...
const FALLBACK_OFFERS: Offer[] = [
  { id: "fb-1", title: "CPX Quantum Survey Matrix", description: "Answer advanced market research surveys on emerging technologies.", payout_coins: 1800, category: "trending", provider: "CPX Research", imageUrl: "https://logo.clearbit.com/cpxresearch.com", difficulty: "Medium", link: "https://cpxresearch.com" },
  { id: "fb-2", title: "BitLabs Protocol Survey", description: "Complete tech-oriented surveys and earn premium rewards.", payout_coins: 1200, category: "trending", provider: "BitLabs", imageUrl: "https://logo.clearbit.com/bitlabs.ai", difficulty: "Easy", link: "https://bitlabs.ai" },
  { id: "fb-3", title: "TOROX Stellar Offerwall", description: "Browse high-paying offers from premium brands across the globe.", payout_coins: 5000, category: "high-paying", provider: "TOROX", imageUrl: "https://logo.clearbit.com/torox.com", difficulty: "Medium", link: "https://torox.com" },
  { id: "fb-4", title: "AdGate Galactic Rewards", description: "Try new apps, games, and services. Get rewarded for every action.", payout_coins: 3500, category: "trending", provider: "AdGate Media", imageUrl: "https://logo.clearbit.com/adgatemedia.com", difficulty: "Medium", link: "https://adgatemedia.com" },
  { id: "fb-5", title: "AdGem Cosmic Install", description: "Install and try new mobile apps. Earn coins per install and session.", payout_coins: 2500, category: "new", provider: "AdGem", imageUrl: "https://logo.clearbit.com/adgem.com", difficulty: "Easy", link: "https://adgem.com" },
  { id: "fb-6", title: "Lootably Nebula Tasks", description: "Complete micro-tasks and quick offers for instant coin rewards.", payout_coins: 800, category: "new", provider: "Lootably", imageUrl: "https://logo.clearbit.com/lootably.com", difficulty: "Easy", link: "https://lootably.com" },
  { id: "fb-7", title: "TimeWall Daily Videos", description: "Watch short videos and complete daily check-ins for coins.", payout_coins: 350, category: "new", provider: "TimeWall", imageUrl: "https://logo.clearbit.com/timewall.io", difficulty: "Easy", link: "https://timewall.io" },
  { id: "fb-8", title: "Revenue Universe Crypto Offer", description: "Register and verify accounts on leading crypto platforms.", payout_coins: 7200, category: "high-paying", provider: "Revenue Universe", imageUrl: "https://logo.clearbit.com/revenueuniverse.com", difficulty: "Hard", link: "https://revenueuniverse.com" },
  { id: "fb-9", title: "Ayet Studios App Install", description: "Download and play featured mobile games. Reach level milestones.", payout_coins: 1500, category: "recommended", provider: "Ayet Studios", imageUrl: "https://logo.clearbit.com/ayetstudios.com", difficulty: "Medium", link: "https://ayetstudios.com" },
  { id: "fb-10", title: "Kiwi Wall Offer Grid", description: "Browse the kiwi wall and complete simple offers for coins.", payout_coins: 1000, category: "recommended", provider: "Kiwi Wall", imageUrl: "https://logo.clearbit.com/kiwiwall.com", difficulty: "Easy", link: "https://kiwiwall.com" },
  { id: "fb-11", title: "Monlix Survey Panel", description: "Join Monlix's survey panel and earn coins for your opinions.", payout_coins: 2000, category: "recommended", provider: "Monlix", imageUrl: "https://logo.clearbit.com/monlix.com", difficulty: "Medium", link: "https://monlix.com" },
  { id: "fb-12", title: "Wannads Offer Exchange", description: "Complete Wannads offers from global advertisers. Instant credit.", payout_coins: 1600, category: "trending", provider: "Wannads", imageUrl: "https://logo.clearbit.com/wannads.com", difficulty: "Easy", link: "https://wannads.com" },
];
