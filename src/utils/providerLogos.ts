...
const DEFAULT_PROVIDERS: ProviderInfo[] = [
  ...
  { id: "prov-main-1", name: "TOROX", slug: "torox", initials: "TX", color: "from-cyan-500 to-blue-600", border: "border-cyan-500/30", bgLight: "bg-cyan-500/10", logoUrl: LOCAL("torox"), domain: "torox.com", category: "main", connected: true },
  ...
  { id: "prov-main-8", name: "Offery", slug: "offery", initials: "OF", color: "from-violet-500 to-purple-600", border: "border-violet-500/30", bgLight: "bg-violet-500/10", logoUrl: "/logos/offery.svg", domain: "offery.io", category: "main", connected: true },
  { id: "prov-main-9", name: "MyChips", slug: "mychips", initials: "MC", color: "from-yellow-500 to-amber-600", border: "border-yellow-500/30", bgLight: "bg-yellow-500/10", logoUrl: LOCAL("mychips"), domain: "mychips.com", category: "main", connected: true },
  { id: "prov-main-10", name: "Notik", slug: "notik", initials: "NT", color: "from-rose-500 to-pink-600", border: "border-rose-500/30", bgLight: "bg-rose-500/10", logoUrl: LOCAL("notik"), domain: "notik.com", category: "main", connected: true },
  { id: "prov-main-11", name: "Upwall", slug: "upwall", initials: "UP", color: "from-blue-500 to-indigo-600", border: "border-blue-500/30", bgLight: "bg-blue-500/10", logoUrl: LOCAL("upwall"), domain: "upwall.com", category: "main", connected: true },
  ...
  { id: "prov-main-13", name: "AdBreak Media", slug: "adbreakmedia", initials: "AB", color: "from-red-500 to-rose-600", border: "border-red-500/30", bgLight: "bg-red-500/10", logoUrl: LOCAL("adbreakmedia"), domain: "adbreakmedia.com", category: "main", connected: true },
  { id: "prov-main-14", name: "MobiVortex", slug: "mobivortex", initials: "MV", color: "from-cyan-500 to-sky-600", border: "border-cyan-500/30", bgLight: "bg-cyan-500/10", logoUrl: LOCAL("mobivortex"), domain: "mobivortex.com", category: "main", connected: true },
  ...
  { id: "prov-main-16", name: "Klink Labs", slug: "klinklabs", initials: "KL", color: "from-lime-500 to-green-600", border: "border-lime-500/30", bgLight: "bg-lime-500/10", logoUrl: LOCAL("klinklabs"), domain: "klinklabs.com", category: "main", connected: true },
  ...
  { id: "prov-main-18", name: "Reward Wall", slug: "rewardwall", initials: "RW", color: "from-pink-500 to-rose-600", border: "border-pink-500/30", bgLight: "bg-pink-500/10", logoUrl: "/logos/rewardwall.svg", domain: "rewardwall.com", category: "main", connected: true },
  ...
  { id: "prov-extra-2", name: "Wannads", slug: "wannads", initials: "WN", color: "from-pink-500 to-rose-600", border: "border-pink-500/30", bgLight: "bg-pink-500/10", logoUrl: LOCAL("wannads"), domain: "wannads.com", category: "extra", connected: false },
];
